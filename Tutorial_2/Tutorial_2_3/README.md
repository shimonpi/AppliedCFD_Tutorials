...
3. To analyze the boundary layer development, plot the velocity profile $`U_x`$ at $`x = 0.1`$. Use the "Plot Over Line" filter:
   ...
   Apply the filter, compare the obtained velocity profile to the Blasius solution for a boundary layer ([u_x_x01.csv](u_x_x01.csv)).

   ![U_x_solution](U_x_solution.png)
